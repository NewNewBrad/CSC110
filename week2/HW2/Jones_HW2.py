...
profile_cost = float(input("Enter a cost of profile in $: "))
siding_nails_cost = float(input("Enter a cost of siding nails in $: "))
siding_strips_cost = float(input("Enter a cost of side strips in $: "))
bundle_cost = float(input("Enter a cost of a bundle of shingles in $: "))
roof_nails_cost = float(input("Enter a cost of roofing nails in $: "))
